  ...
  _initializeView (params, retryCount) {
    ...
    const onload = () => {
      ...
      this._config.onkey('easyCommentOpacity',
        _.debounce(
          v => {
            console.log('update easyCommentOpacity', v, this._config.easyCommentOpacity, commentLayerOuter);
            cssUtil.setProps(
      ...
      this._config.onkey('aiCommentOpacity',
        _.debounce(
          v => {
            console.log('update aiCommentOpacity', v, this._config.aiCommentOpacity, commentLayerOuter);
            cssUtil.setProps(
